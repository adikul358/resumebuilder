    ...
    return (
        <>
            <nav className="max-w-6xl w-full mx-auto flex flex-row items-center justify-between max-lg:px-3 h-[72px] text-white z-10">
                <Link href="/"><span className="text-2xl font-display font-bold">
                    LaTeX<span className="text-[#acf4e8]">Resume</span></span>
                </Link>
                <div className="flex flex-row items-center gap-x-6 font-medium">
                    <a href="#features">Features</a>
                    <a href="#contact-us">Contact Us</a>
                    <Link href="/signup" className="px-4 py-1 border border-white/25 bg-secondary text-white rounded-lg font-medium">Sign Up</Link>
                </div>
            </nav>
            <div className="bg-linear-to-tl from-secondary to-primary -mt-[72px] pt-[72px] max-lg:px-3 text-white">
                <div className="max-w-6xl mx-auto flex flex-col items-center py-24">
                    ...
                    <Link href="/signup" className="px-8 py-3 mt-8 text-white bg-secondary font-bold rounded-full shadow-md shadow-[#2d7e7045]">
                        Start Building
                    </Link>
                </div>
            </div>
                    ...
                    <form id="contact-form" className="p-8 mt-8 bg-white rounded-lg shadow-md shadow-[rgba(0,0,0,0.09)] max-w-2xl w-full">
                        <div className="">
                            ...
                            <input type="text" id="name" name="name" placeholder="John Doe" required
                                className="mt-1 block w-full px-3 py-2 border border-gray-300 rounded-md shadow-xs focus:outline-hidden focus:ring-2 focus:ring-primary/75 focus:border-primary/75 sm:text-sm"
                            />
                        </div>
                        <div className="mt-6">
